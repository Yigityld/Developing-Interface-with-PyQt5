...
class App(QMainWindow):
    def __init__(self):
        ...
        slider_labels = ["yaw", "roll", "pitch", "kalibrasyon"]
        ...
        # Diğer kod kısmınızı bu stili uygulamak için kullan

        main_h_layout = QHBoxLayout()
        center_v_layout = QVBoxLayout()

        # "Hız" etiketini oluşturun
        speed_label = QLabel("Hız", self)
        speed_label.setAlignment(Qt.AlignCenter)  # Etiketi merkeze hizala
        center_v_layout.addWidget(speed_label)

        # Dikey slider'ı oluşturun
        ...
        # Center layout'u ana h_layout'a ekleyin
        main_h_layout.addLayout(center_v_layout)

        # Butonlar için bir QVBoxLayout oluşturma
        ...
        for index, (val1, val2) in enumerate(button_values):
            ...
            # Buton adı için bir label oluştur ve h_layout'a ekleyin
